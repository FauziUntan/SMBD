...
<form action="update.php" method="POST">
  ...
  <?php
    ...
    echo"<input type='text' placeholder='Suhu' name='firstname' value='{$row['firstname']}' required>";
    echo"<input type='text' placeholder='Gas' name='middlename' value='{$row['middlename']}' required>";
    echo"<input type='text' placeholder='Kondisi' name='lastname' value='{$row['lastname']}' required>";
  	echo"<label><b>Tanggal</b>";
